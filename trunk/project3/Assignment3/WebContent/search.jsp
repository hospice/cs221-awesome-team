...
<body>
	<form method="GET" action=""> <!-- "Reload" this same page with the new query -->
	<div id="search-container" class="top">
		<div class="inputGroup">
			<h1 id="header-small"><a href="index.jsp">ArVi</a></h1>
			<input type="text" name="query" id="txtQuery" value="<%= request.getParameter("query") != null ? request.getParameter("query") : "" %>" />
